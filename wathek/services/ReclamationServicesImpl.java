...
//    }
    ...
    public Reclamation ajouterReclamation(ReclamationRequest reclamationRequest) {
        ...
        Produit produit = produitRepository.findById(reclamationRequest.getProduit()).orElseThrow(() -> new RuntimeException("Product not found"));

        User acheteur = userRepository.findById(reclamationRequest.getAcheteur()).orElseThrow(() -> new RuntimeException("User not found"));
        ...
        Reclamation reclamation = new Reclamation();
        reclamation.setLivreur(userRepository.findById(reclamationRequest.getLivreur()).get());
        reclamation.setAcheteur(acheteur);
        reclamation.setProduit(produit);
        reclamation.setDescription(reclamationRequest.getText());
        reclamation.setDate(new Date());
